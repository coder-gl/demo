...
public class RedisClusterConfig {
    ...
    @Primary
    public LettuceConnectionFactory lettuceConnectionFactory(GenericObjectPoolConfig redisPool, @Qualifier("redisClusterConfiguration") RedisClusterConfiguration redisClusterConfig) {
        LettucePoolingClientConfiguration lettucePoolingClientConfiguration  = LettucePoolingClientConfiguration
                ...
                .build();
        return new LettuceConnectionFactory(redisClusterConfig, lettucePoolingClientConfiguration);
    }
